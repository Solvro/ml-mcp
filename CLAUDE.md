...
│   │   ├── deterministic_topology.py # One type and direction for category->item edges
...
it can produce. Existing edges written before relationship canonicalization remain as-is until
the graph is re-ingested.
